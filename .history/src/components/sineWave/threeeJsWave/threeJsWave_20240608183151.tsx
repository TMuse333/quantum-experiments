...
const ThreeJSWave: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const waves = [
      createWaveMesh(20, 10, 100, 100, 0x00bfff), // Sky Blue
      createWaveMesh(20, 10, 100, 100, 0x4b0082), // Indigo
      createWaveMesh(20, 10, 100, 100, 0x8a2be2), // Blue Violet
      createWaveMesh(20, 10, 100, 100, 0x483d8b), // Dark Slate Blue
      createWaveMesh(20, 10, 100, 100, 0x0000ff), // Blue
    ];
